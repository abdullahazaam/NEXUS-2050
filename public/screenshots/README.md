...
Add genuine captures of the running application, using these filenames:

- `nexus-hero.png` — 1440px desktop hero, after the loader exits.
- `nexus-command-center.png` — dashboard with the 24H range selected.
- `nexus-simulation.png` — simulation with the Sustainable Future preset.
- `nexus-mobile.png` — 390px mobile experience.
